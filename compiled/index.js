...
var main = function () {
    ...
    var addOrgPrefixFlag = core.getInput('addOrgPrefix');
    ...
    var addOrgPrefix = (addOrgPrefixFlag !== '');
    if (overwrite) {
